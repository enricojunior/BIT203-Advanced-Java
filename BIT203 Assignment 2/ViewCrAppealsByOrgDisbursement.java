 ...
 * Student ID: E2100297
 * ViewCrAppealsByOrgDisbursement.java
 * Date: 27-12-2023
...
/**
 * ViewCrAppealsByOrgDisbursement class is responsible of displaying list of the
 * Current Appeals made by a specific Organization when the Representative wants
 * to record an aid disbursement to the specified Applicant.
 */
public class ViewCrAppealsByOrgDisbursement extends javax.swing.JFrame {
    ...
    /**
     * ViewCrAppealsByOrgDisbursement Form
     * Default Constructor of ViewCrAppealsByOrgDisbursement to initialize all of the required components
     * @param HELPAid - HELPAid
     * @param currentUser - User
     */
    public ViewCrAppealsByOrgDisbursement(HELPAid HELPAid, User currentUser) {
     ...
     * Where the Representative wishes to record an aid disbursement
     */
    private void ProceedBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProceedBtnActionPerformed
        ...
        try {
            ...
            if(IDTextField.getText().isEmpty()){
                // It will display the following message if the Text fields remains empty blank
            ...
            // Check if the Appeal was found by the choosen ID
                ...
                // Check if there aren't any contributions made according to the choosen Appeal
                if(dctAppeal.getContributionList().isEmpty()){
                    // Display the following message if there aren't any contributions available for the choosen Appeal
                    JOptionPane.showMessageDialog(this, "There aren't any contributions available for the choosen Appeal!");
                }
                // Check if there are any available contributions from the choosen Appeals
                else {
                    // Redirect the Representative to the View Contributions Panel
                    // Set its visibility to true and dispose the previous frame
                    ViewContributions ViewConsPanel = new ViewContributions(HELPAid, currentUser, dctAppeal);
