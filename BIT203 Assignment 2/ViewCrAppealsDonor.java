...
/**
 * ViewCrAppealsDonor class is responsible of displaying list of the
 * Current Appeals from various Organizations when the Donor wants to
 * record a new contribution according to the selected Appeal.
 */
public class ViewCrAppealsDonor extends javax.swing.JFrame {
    ...
    /**
     * ViewCrAppealsDonor Form
     * Default Constructor of ViewCrAppealsDonor to initialize all of the required components
     * @param HELPAid - HELPAid
     */
    public ViewCrAppealsDonor(HELPAid HELPAid) {
    ...
    private void initComponents() {
        ...
        ViewCurrentAppealsDonorPanel = new javax.swing.JPanel();
        ...
        ViewCurrentAppealsDonorPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        javax.swing.GroupLayout ViewCurrentAppealsDonorPanelLayout = new javax.swing.GroupLayout(ViewCurrentAppealsDonorPanel);
        ViewCurrentAppealsDonorPanel.setLayout(ViewCurrentAppealsDonorPanelLayout);
        ViewCurrentAppealsDonorPanelLayout.setHorizontalGroup(
            ViewCurrentAppealsDonorPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ViewCurrentAppealsDonorPanelLayout.createSequentialGroup()
                ...
                .addGroup(ViewCurrentAppealsDonorPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(ViewCurrentAppealsDonorPanelLayout.createSequentialGroup()
        ...
        ViewCurrentAppealsDonorPanelLayout.setVerticalGroup(
            ViewCurrentAppealsDonorPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(ViewCurrentAppealsDonorPanelLayout.createSequentialGroup()
                .addGroup(ViewCurrentAppealsDonorPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(UpperIconPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(ViewCurrentAppealsDonorPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(ViewCurrentAppealsDonorPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
     ...
     * Where the Donor wishes to add a new contribution according to the selected Appeal
     * @param evt
     */
    private void ProceedBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProceedBtnActionPerformed
        ...
        try {
            ...
            // Check if the Appeal was found by the choosen ID
                ...
                destroyFields();
                // Redirect the Donor to the Contribution Selection Panel
                // Set its visibility to true and dispose the previous frame
                ContributionSelectPanelDonor CrSctPanel = new ContributionSelectPanelDonor(HELPAid, dctAppeal);
                CrSctPanel.setVisible(true);
                dispose();
            }
    ...
    private javax.swing.JPanel ViewCurrentAppealsDonorPanel;
