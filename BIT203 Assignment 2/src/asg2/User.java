...
abstract public class User implements Comparable<User>, Serializable {
     ...
     * This method is used to compare two different users its full name
     * @return boolean
     */
    @Override
    public boolean equals(Object obj){
        // check if the specified obj is true
        if(this == obj){
            return true;
        }
        // Check if the obj is not an instance of User
        if(!(obj instanceof User)){
            return false;
        }
        User myUser = (User) obj; // apply-downcast
