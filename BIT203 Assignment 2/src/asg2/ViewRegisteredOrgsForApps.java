 ...
 * Student ID: E2100297
 * ViewRegisteredOrgsForApps.java
 * Date: 27-12-2023
...
/**
 * ViewRegisteredOrgForApps class is responsible of displaying
 * List of the Registered Organizations to the Applicant.
 * If the Applicant wants to register themselves online.
 * This Panel will be displayed when the Applicant clicked the self-registration button.
 */
public class ViewRegisteredOrgsForApps extends javax.swing.JFrame {
    ...
    /**
     * ViewRegisteredOrgsForApps Form
     * Default Constructor of ViewRegisteredOrgsForApps to initialize all of the required components
     * @param HELPAid - HELPAid
     */
    public ViewRegisteredOrgsForApps(HELPAid HELPAid) {
        ...
        OrganizationTable.getColumnModel().getColumn(1).setPreferredWidth(100);
        OrganizationTable.getColumnModel().getColumn(2).setPreferredWidth(100);
     ...
     * Where the Applicant wants to return back to the Applicant Enter Controller Panel
     * @param evt
     */
    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtonActionPerformed
        // Redirect the Applicant to the Applicant Enter Controller Panel
     ...
     * Where the Applicant wants to proceed moving on to the Registration Panel
     * @param evt
     */
    private void ProceedBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProceedBtnActionPerformed
        ...
        try {
            ...
            // Check if the Organization was found by the choosen ID
                ...
                // Redirect the Applicant to the Applicant Self-Registration Form Panel
                // set its visibility to true and dispose the previous frame
                RegisterApplicantOnline regAppOnline = new RegisterApplicantOnline(HELPAid, dctOrg);
                regAppOnline.setVisible(true);
                dispose();
            } 
            ...
            // catch an exception if the Applicant enters an invalid data type to the Text field
