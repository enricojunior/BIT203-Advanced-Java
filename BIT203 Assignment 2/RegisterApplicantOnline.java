...
/**
 * The RegisterApplicantOnline is responsible of displaying the Applicant's Registration Form,
 * if the Applicant proceeds to self-registration by selecting the destinated Organization by ID
 */
public class RegisterApplicantOnline extends javax.swing.JFrame {
    ...
    /**
     * RegisterApplicantOnline Form
     * Default Constructor of RegisterApplicantOnline to initialize all of the required components
     * @param HELPAid - HELPAid
     * @param dctOrg - Organization
     */
    public RegisterApplicantOnline(HELPAid HELPAid, Organization dctOrg) {
    ...
    private void initComponents() {
        ...
        RegisterAppOnlineLabel = new javax.swing.JLabel();
        ...
        SideLeftPanelLayout.setHorizontalGroup(
            ...
            .addGroup(SideLeftPanelLayout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addComponent(BackButtonApp, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        RegisterAppOnlineLabel.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        RegisterAppOnlineLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        RegisterAppOnlineLabel.setText("Register Applicant Online");
                            ...
                            .addGroup(RegisterApplicantMainPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(RegisterApplicantMainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(RegisterApplicantMainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(RegisterAppOnlineLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        RegisterApplicantMainPanelLayout.setVerticalGroup(
            ...
            .addGroup(RegisterApplicantMainPanelLayout.createSequentialGroup()
                ...
                .addComponent(RegisterAppOnlineLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(12, 12, 12)
    ...
    private void BackButtonAppActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackButtonAppActionPerformed
        ...
        ApplicantEnterController newAppController = new ApplicantEnterController(HELPAid);
        newAppController.setVisible(true);
        dispose();
    }//GEN-LAST:event_BackButtonAppActionPerformed

    /**
     * The method below is used to add an event to the submit button
     * Where the Applicant proceeds to register themselves to the selected Organization
     * @param evt
     */
    private void SubmitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitBtnActionPerformed
        ...
        try {
            ...
            // Check if the Applicant's data input is valid 
            else {
                ...
                // Set the Applicant specified Organization according to the Applicant's selected Organization
                newApplicant.setSpecifiedOrg(dctOrg);
                ...
                if(HELPAid.DuplicateUName(newApplicant.getUsername())){
                    ...
                    // clear the form fields
                    destroyFields();
                    // Return back to the Applicant Controller and destroy the created object
                    // set its visibility to true and dispose the previous frame
                    ApplicantEnterController AppCtrl = new ApplicantEnterController(HELPAid);
                    AppCtrl.setVisible(true);
                    dispose();
                }
                // Check if the system did not find any duplicate Username
                else {
                    // Display the following message if the Applicant has been successfully registered to the system
                    ...
                    dctOrg.addApplicant(newApplicant);
                    // clear the form fields
                    destroyFields();
                    
                    // Moving on to create document panel for the registered Applicant
                    // set its visibility to true and dispose the previous frame
                    AppendDocOnline newAddDoc = new AppendDocOnline(HELPAid, newApplicant);
                    newAddDoc.setVisible(true);
                    dispose();                   
                }
            }
        }
        catch(Exception e){
            // catch an exception if the Applicant enters an invalid data type for Applicant's Income, Mobile Number, or ID Number
    ...
    private javax.swing.JLabel RegisterAppOnlineLabel;
